...
/** @internal **/
export const context: IModuleContext = new ModuleContext("com-seatmapsworkflow-web-module");
/** @internal **/
...
/** @internal **/
export const t: ScopedTranslator = getService(I18nService).getScopedTranslator('com-seatmapsworkflow-web-module/translations');
