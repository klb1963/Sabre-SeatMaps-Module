...
/** @internal **/
export const context: IModuleContext = new ModuleContext("com-sabreseatmaps-web-module");
/** @internal **/
...
/** @internal **/
export const t: ScopedTranslator = getService(I18nService).getScopedTranslator('com-sabreseatmaps-web-module/translations');
